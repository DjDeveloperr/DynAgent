...
- `ComposerSelectionModel.swift`: tested composer model/reasoning selection state for Codex availability, conversation adoption actions, desired-model adoption, fallback selection, and picker updates.
