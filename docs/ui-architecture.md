...
- `TranscriptChrome.swift`: reusable AppKit transcript text, full-width row append/stack helpers, loading shell rows, shimmer/thinking rows, work-divider, edit-stat, and transcript row views.
